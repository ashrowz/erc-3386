...
library StructuredLinkedList {
    ...
    /**
     * @dev Returns the value of the head
     * @param self stored linked list from contract
     * @return bool, uint256  true if head exists or false otherwise, the node's index
     */
    function getHead(List storage self) internal view returns (bool, uint256) {
        return getNextNode(self, _HEAD);
    }
